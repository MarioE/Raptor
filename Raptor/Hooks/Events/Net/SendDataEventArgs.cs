...
{
    /// <summary>
    ///     Provides data for the <see cref="NetHooks.SendData" /> event.
    /// </summary>
    [PublicAPI]
    public class SendDataEventArgs : HandledEventArgs
    {
        internal SendDataEventArgs(int packetType, NetworkText text, int number1, float number2, float number3,
