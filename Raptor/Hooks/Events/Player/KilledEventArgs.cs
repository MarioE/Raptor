...
{
    /// <summary>
    ///     Provides data for the <see cref="PlayerHooks.Killed" /> event.
    /// </summary>
    [PublicAPI]
    public sealed class KilledEventArgs : EventArgs
    {
        internal KilledEventArgs(Terraria.Player player, PlayerDeathReason damageSource, int damage, bool isPvP)
        {
            Player = player;
